...
CLEAN_STATE = [
    ...
    ("set", "base_image", "hearmeman/comfyui-base:cu130-comfy0.36.0-3dd559d8-torch2.11.0"),
...
def test_clean_boot_is_compact():
    with tempfile.TemporaryDirectory() as td:
        ...
        ok("  ComfyUI    v0.36.0 (approved)" in out, out)
        ok("  Runtime    comfyui-runtime @ 28a4ca1" in out, out)
        ok("  Base       cu130-comfy0.36.0-3dd559d8-torch2.11.0" in out, out)
